...
__all__ = ['ts_par7_trial']


class TsPar7Trial(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='ts',
            model_name='par7_trial',
            model_type='',
            data_columns=(
                'subjID',
                'level1_choice',
...
def ts_par7_trial(
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('ts_par7_trial').
    ...
    .. code:: python
        ...
        output = ts_par7_trial(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
