...
__all__ = ['ts_akam_par7']


class TsAkamPar7(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='ts',
            model_name='akam_par7',
            model_type='',
            data_columns=(
                'subjID',
                'level1_choice',
...
def ts_akam_par7(
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('ts_akam_par7').
    ...
    .. code:: python
        ...
        from hbayesdm.models import ts_akam_par7

        # Run the model and store results in "output"
        output = ts_akam_par7(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
