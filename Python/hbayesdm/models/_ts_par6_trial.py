...
__all__ = ['ts_par6_trial']


class TsPar6Trial(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='ts',
            model_name='par6_trial',
            model_type='',
            data_columns=(
                'subjID',
                'level1_choice',
...
def ts_par6_trial(
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('ts_par6_trial').
    ...
    .. code:: python
        ...
        output = ts_par6_trial(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
