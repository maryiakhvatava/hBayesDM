...
__all__ = ['ts_akam_par4']


class TsAkamPar4(TaskModel):
...
def ts_akam_par4(
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('ts_akam_par4').
    ...
    .. code:: python
        ...
        output = ts_akam_par4(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
