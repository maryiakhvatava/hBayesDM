...
__all__ = ['ts_par4_trial']


class TsPar4Trial(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='ts',
            model_name='par4_trial',
            model_type='',
            data_columns=(
                'subjID',
                'level1_choice',
...
def ts_par4_trial(
    ...
    .. codeauthor:: Harhim Park / Maryia <hrpark12@gmail.com>
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('ts_par4_trial').
    ...
    .. code:: python
        ...
        output = ts_par4_trial(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
