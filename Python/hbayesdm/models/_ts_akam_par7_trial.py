...
__all__ = ['ts_akam_par7_trial']


class TsAkamPar7Trial(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='ts',
            model_name='akam_par7_trial',
            model_type='',
            data_columns=(
                'subjID',
                'level1_choice',
...
def ts_akam_par7_trial(
    ...
    """Two-Step Task - Hybrid Model for reduced task
    ...
    .. [Akam2015] Akam, T., Costa, R., & Dayan, P. (2015). Simple Plans or Sophisticated Habits? State, Transition and Learning Interactions in the Two-Step Task. PLoS Comput Biol, 11(12):e1004648. https://doi.org/10.1371/journal.pcbi.1004648

    .. codeauthor:: Franziska Knolle/Maryia <franziskaknolle@gmail.com>
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('ts_akam_par7_trial').
    ...
    .. code:: python
        ...
        from hbayesdm.models import ts_akam_par7_trial

        # Run the model and store results in "output"
        output = ts_akam_par7_trial(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
