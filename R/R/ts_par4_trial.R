#' @templateVar MODEL_FUNCTION ts_par4_trial
#' @templateVar CONTRIBUTOR \href{https://ccs-lab.github.io/team/harhim-park/}{Harhim Park / Maryia} <\email{hrpark12@@gmail.com}>
...
#' @templateVar MODEL_CODE par4_trial
